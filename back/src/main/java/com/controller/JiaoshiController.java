...
public class JiaoshiController {
    ...
    @Autowired
    private KechengYuyueService kechengYuyueService;//课程选课
    @Autowired
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            jiaoshiEntity.setJiaoshiName(data.get(1));                    //教师名称 要改的
                            jiaoshiEntity.setJiaoshiPhone(data.get(2));                    //教师手机号 要改的
                            jiaoshiEntity.setJiaoshiIdNumber(data.get(3));                    //教师身份证号 要改的
                            jiaoshiEntity.setJiaoshiPhoto("");//详情和图片
                            jiaoshiEntity.setSexTypes(Integer.valueOf(data.get(4)));   //性别 要改的
                            jiaoshiEntity.setJiaoshiEmail(data.get(5));                    //教师邮箱 要改的
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                if(seachFields.containsKey("jiaoshiPhone")){
                                    ...
                                    jiaoshiPhone.add(data.get(2));//要改的
                                }else{
                                ...
                                if(seachFields.containsKey("jiaoshiIdNumber")){
                                    ...
                                    jiaoshiIdNumber.add(data.get(3));//要改的
                                }else{
